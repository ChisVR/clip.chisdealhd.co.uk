...
import { fetcher } from "../../lib/fetchertwitch";
...
const ClipsPage: NextPage<Props> = ({ clips, lastUpdated, error }) => {
  ...
  return (
    <ClipsBody>
      <Head>
        <title>clip.nekosunevr.co.uk - NekoSuneVR's Twitch Clips</title>
      </Head>
      <Heading>
        <h1>Twitch.tv Clips</h1>
        <p>Last Updated: {lastUpdated}</p>
      </Heading>
      <ClipsContainer>
        {clips.map((clip: Clip) => (
          <Link href="/twitchtv/[clip]" as={`/twitchtv/${clip.contentId}`}>
            <a>
